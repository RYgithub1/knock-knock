...
現状最適なツールが見当たらず、旅人同士は現地で出会った人と直接情報交換をする事が多いです。  
...
- 右上の「visiter」ポップアップは、ログイン後に、ログイン中のユーザー情報が表示されます。
...
- 相手が気になるけどメッセージの送付は一端保留するなどの場合、相手のドアに、ドアハンガーをかけておきます（ホテルでドアにかかっているプレートのイメージです）。
